/**
 * Avatar Utilities
 * Contains avatar-specific utilities and helper functions
 */
...
import { AVATAR_LAYER, NONE, SETTINGS, SPECIAL_AVATARS } from '@/utils/constant'
...
/**
 * Get a random fill color from the available colors
 */
...
/**
 * Generate a random avatar option with all properties
 */
...
/**
 * Get a random special avatar option from predefined special avatars
 */
