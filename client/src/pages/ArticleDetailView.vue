  ...
  <div class="theme-page min-h-screen py-20">
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <article
        ...
        class="bg-white/60 dark:bg-white/10 backdrop-blur-md rounded-2xl overflow-hidden border border-gray-200/50 dark:border-white/20 shadow-xl"
      >
        <!-- 骨架屏 -->
        <div v-if="loading" class="animate-pulse">
          ...
          <div class="p-8">
            <div
              class="h-8 bg-gray-300 dark:bg-gray-700 rounded w-3/4 mb-4"
            ></div>
            <div
              class="h-4 bg-gray-300 dark:bg-gray-700 rounded w-1/2 mb-4"
            ></div>
            <div class="space-y-3">
          ...
          <div class="mb-8">
            ...
            <div class="flex flex-wrap items-center gap-2 mb-4">
              <span
                ...
                class="px-3 py-1 bg-blue-100 dark:bg-blue-900/30 text-blue-600 dark:text-blue-400 text-sm rounded-full"
              >
                {{ article.category }}
              </span>
              <span
            ...
            <!-- 作者和元信息 -->
            <div
              class="flex flex-wrap items-center gap-6 text-gray-600 dark:text-gray-400"
            >
              <!-- 作者 -->
    ...
    <!-- 分享卡片生成预览 -->
    <div
      v-if="showCardPreview"
      class="fixed inset-0 bg-black/50 flex items-center justify-center p-4 z-50"
      @click="showCardPreview = false"
    >
      <div
        class="bg-white dark:bg-gray-800 rounded-2xl p-8 max-w-lg w-full"
        @click.stop
      >
        ...
        <div
          id="share-card"
          class="bg-gradient-to-br from-blue-500 to-purple-600 rounded-2xl p-8 text-white mb-4"
        >
          <div class="mb-6">
            <h2 class="text-2xl font-bold mb-2">{{ article?.title }}</h2>
            <p class="text-blue-100 text-sm line-clamp-3">
...
const copyButtonHandlers: Array<{
