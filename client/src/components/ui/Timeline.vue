...
<template>
  <div ref="timelineContainerRef" class="w-full font-sans">
    <div ref="timelineRef" class="relative z-0">
      <div
        v-for="(item, index) in props.items"
        :key="item.id + index"
        class="pt-10 md:gap-10"
      >
        <div
        ...
        >
          ...
          >
            <div
              class="size-4 rounded-full border bg-gray-400 dark:bg-gray-500"
            />
          </div>
        </div>
        <div class="pl-20"><slot :name="item.id" /></div>
      </div>
      <div
        :style="{
          height: `${height}px`,
